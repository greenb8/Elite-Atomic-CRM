						...
						onSuccess: async (data: any) => {
							...
							try {
								...
								for (const it of existing.data as any[]) {
									await dataProvider.delete('deal_line_items', { id: it.id, previousData: it });
								}
								...
								notify('Deal updated');
								redirect(`/deals/${data.id}/show`, undefined, undefined, undefined, { _scrollToTop: false });
							} catch (e) {
								notify('Error updating line items', { type: 'error' });
							}
						},
					}}
				>
